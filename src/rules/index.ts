interface RegexPattern {
	Letters: RegExp;
	LettesAndNumbers: RegExp;
	LettersAndSpaces: RegExp;
	LettersAndSpacesAndDashes: RegExp;
	LettersAndSpacesAndDashesAndNumbers: RegExp;
	LettersAndSpacesAndUNDERSCORE: RegExp;
	Numbers: RegExp;
	NumbersAndSpaces: RegExp;
	NumbersAndDot: RegExp;
	NumbersAndSpacesAndDashes: RegExp;
	Email: RegExp;
	Phone: RegExp;
	URL: RegExp;
	Date: RegExp;
...
const regexPattern: RegexPattern = {
	...
	PASSWORD: /^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[^a-zA-Z0-9])\S{8,99}$/,
};
